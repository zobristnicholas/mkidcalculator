...
class Qi:
    ...
    def mattis_bardeen(cls, params, temperatures, low_energy=False, parallel=False):
        """
        Returns the inverse internal quality factor of the resonator with the
        specified model parameters for Mattis Bardeen effects.
        Args:
            params: lmfit.Parameters() object
                The parameters for the model function.
            temperatures: numpy.ndarray
                The temperatures at which the quality factor is evaluated. If
                None, an inverse quality factor of zero is returned.
        ...
        f0 = params['f0'].value
        # calculate Qinv
        sigma = cc.value(temperatures, f0, tc, gamma=dynes, bcs=bcs, low_energy=low_energy, parallel=parallel)
    ...
    def two_level_systems(cls, params, temperatures, powers):
        ...
        Args:
            ...
            temperatures: numpy.ndarray
                The temperatures at which the quality factor is evaluated. If
                None, only the power dependence is used.
    ...
    def model(cls, params, temperatures=None, powers=None, low_energy=False, parallel=False):
        ...
        Args:
            ...
            temperatures: numpy.ndarray (optional)
                The temperatures at which the quality factors are evaluated.
                The default is None and the temperature's effect on the quality
                factor is ignored.
            powers: numpy.ndarray (optional)
                The powers at which the quality factors are evaluated. The
                default is None and the power's effect on the quality factor is
                ignored.
            low_energy: boolean (optional)
                Use the low energy approximation to evaluate the complex
                conductivity. The default is False.
    ...
    def guess(cls, data, f0, tc, alpha=0.5, bcs=BCS, temperatures=None, powers=None, gamma=1., fit_resonance=False,
        ...
        Args:
            ...
            temperatures: numpy.ndarray (optional)
                The temperatures at which the Qi data is taken. The default is
                None. If specified, this helps set the fd parameter to a
                reasonable value.
            powers: numpy.ndarray (optional)
                The powers at which the Qi data is taken. The default is None.
            ...
            fit_resonance: boolean (optional)
                A boolean specifying if the offset frequency, f0, should be
                varied during the fit. The default is False.
            ...
            fit_loss: boolean (optional)
                A boolean specifying whether to fit a constant loss to the
